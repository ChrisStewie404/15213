...
word f_predPC = [
	...
	f_icode == IJXX && imem_ifun == FNONE : f_valC;
	f_valC == f_valP : f_valC;
	f_valC >=0 && f_valP >=0 && f_valC > f_valP : f_valP;
	f_valC >=0 && f_valP >=0 && f_valC < f_valP : f_valC;
	f_valC <0 && f_valP <0 && f_valC > f_valP : f_valP;
	f_valC <0 && f_valP <0 && f_valC < f_valP : f_valC;
	f_valC <0 && f_valP >=0 : f_valP;
	f_valC >=0 && f_valP <0 : f_valC;
];
